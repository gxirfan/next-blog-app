    ...
    <div className="mx-auto space-y-8 ">
      <div className="flex flex-col mb-16 relative">
        ...
        <div className="flex flex-wrap items-center gap-5 mb-16">
          <Link
            href="/post/all"
            className="group relative inline-flex items-center gap-3 px-10 py-5 bg-white text-black rounded-full font-black text-xs tracking-[0.2em] transition-all hover:bg-cyan-500 active:scale-95"
          >
          ...
          <Link
            href="/stream"
            className="group relative inline-flex items-center gap-4 px-10 py-5 bg-neutral-900 border-2 border-neutral-800 text-white rounded-full font-black text-xs tracking-[0.2em] transition-all duration-500 hover:border-cyan-500 hover:text-cyan-400 active:scale-95 overflow-hidden"
          >
