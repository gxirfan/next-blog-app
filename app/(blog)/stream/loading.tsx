...
export default function FlowLoading() {
  return (
    <div className="w-full mx-auto space-y-12 pb-20 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col items-center justify-center py-20 bg-neutral-950 border border-neutral-800 rounded-4xl overflow-hidden relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 opacity-40">
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="p-6 bg-neutral-950 border border-neutral-800 rounded-4xl space-y-4 animate-pulse"
