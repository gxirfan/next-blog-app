...
export default function PostDetailsFooter({
  ...
  return (
    <>
      <div className="mt-24 pt-12 border-t border-neutral-800 flex flex-col mb-20">
        <PostMetaBar
        ...
        {/* <div className="flex flex-col md:flex-row justify-between items-center py-6 border-t border-neutral-900 gap-4 opacity-50 mt-12">
